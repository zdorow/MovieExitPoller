...
public class StatsActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        barGraph_Data3.appendData(new DataPoint(barGraph_Data3.getHighestValueX() + 1, 0), false, 6);
        ...
        mResponseViewModel.getAnswerAverage3_1().observe(this, new Observer<Integer>() {
            ...
            public void onChanged(@Nullable Integer number) {
                ...
                barGraph_Data3.appendData(new DataPoint(barGraph_Data3.getHighestValueX() + 1, number), false, 6);
